...
> - mgf: $e^\lambda e(^t-1)$
> - If $x_1 ~ Poisson(\lambda_1)$ & $x_2 ~ Poisson(\lambda_1)$, then $x_1+x_2 ~Poisson(\lambda_1+\lambda_2)$
...
On average, there are 12 sixes in a t20 match. 
