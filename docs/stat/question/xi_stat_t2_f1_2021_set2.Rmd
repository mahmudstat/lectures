...
a. What is a scatter diagram? \hfill 1
b. Is the correlation coefficient unit-free? Show mathematically.\hfill 2
c. Draw a scatter diagram from the given data and comment on the relationship. \hfill 3
d. Find the influence of aphelion on perihelion and explain. How realistic is the relationship? \hfill 4

2. **Answer in short.**

a. Write three uses of correlation analysis \hfill 2
...
|:-------------------------------------:|:----------------------:|:-----:|
| $Y = \alpha _1 + \beta _1 X + \epsilon$ | $\hat Y = 2.4 - 8.2 X$ |  75%  |
| $Y = \alpha _2 + \beta _2 X + \epsilon$ |  $\hat Y = - 1.2 + 2.6X$  |  96%  |
