...
**4. A statistician of a customer care center investigates the calls received and finds that the call center receives 5 calls per hour on average.**
...
**6. Probability distribution of a random variable is shown on the table:**
