...
c. Find, using Binomial distribution, the probability it would not rain at all on the observed days.
...
d. For projecting (predicting future values), is geometric better than the exponential method. Justify. 
