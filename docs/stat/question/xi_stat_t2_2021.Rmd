...
d. Estimate the skewness of the distribution and explain. 
...
a. Which variable should be the dependent?
b. Is the regression coefficient always unit-free? Briefly explain.
c. Fit a regression line from the above data (i.e., find regression coefficients and write the fitted model)
d. If the regression model is $Y = \alpha + \beta X + \epsilon$, what is the value of $\alpha$ and why? 
...
22. $\beta = 0.25$; What is not a correct interpretation? (2 marks)
...
23. Range of regression coefficient is - 
...
```{r scat, echo=FALSE, fig.cap = "Cover", fig.align = 'center', out.width = '30%'}
...
Answer the question 36-38 according to the following table
