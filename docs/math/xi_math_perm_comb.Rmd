...
<div class="container">
<div class="col">
a. Find summation of 3-digits numbers made using 1, 2, & 3. 
b. Find summation of all possible numbers above 100,00, made using the digits 0, 2, 4, 6, 8. 
b. Sum of all possible numbers using 1, 2, 3, 4
c. Make the general formula to find sum of all possible numbers
</div>
<div class="col">
> - 2!(1+2+3)(1+10+100) 
...
a. Arrange 10 BSC and  14 ISC students so no two BSC students are together.
b. Arrange p +ve and q $-ve$ signs ($p\lt q$) so $-ve$ signs are apart.
c. Arrange a 15-members committee in 15 seats, keeping the chief guest in middle. 
