...
> - $^nC_r = {n! \over r!(n-r)!}$
> - $^nC_r \times ^nP_r = ^nP_r = ^nP_r \times r!$ (Permutation-combination relationship)
...
## Having Some Homogeneous Items

If out of n items, p items are homogeneous, then taking r items ($r \ge p$)

Number of selection options, 

$$N = \sum_{i=0}^p {n-p}C_{r-i}$$

1. Combine THESIS taking 4 letters 
2. 